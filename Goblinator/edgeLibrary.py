...
class edgeLibrary:
    ...
    def populate(self):
        self.edges = [Edge.Edge("Master Sprinter",{1:["attr", "vigor", "at least", 3], 2:["attr","strength","at least",5], 3:["edge","Fleet-Footed", "equal", 0]}, "Through rigorous training, this character has gained the ability to run very fast. Permanent pace increase, and this character rolls a d12 at +2 when determining sprint distance", {1:["pace", 0, "plus", 2]}),
                      ...
                      Edge.Edge("Very Attractive",{1:["edge", "Attractive", "equal", 0]}, "Very Easy on the eyes", {1:["charisma", "", "plus", 2]}),
                      Edge.Edge("Beast Master",{1:["attr", "spirit", "at least", 3]}, "This character is close to an animal familiar", {1:["parry", "", "plus", 0]}),
                      Edge.Edge("Beast Bond",{1:["edge", "Beast Master", "equal", 0]}, "This character is so close to his/her familiar that the two share a benny pool", {1:["parry", "", "plus", 0]}),
                      ...
                      Edge.Edge("Improved Block",{1:["level", "", "at least", 8], 2:["edge", "Block","equal", 0]}, "A true warrior, this character's defenses are nigh-impenetrable", {1:["parry", "", "plus", 1]}),
                      ...
                      Edge.Edge("Bruiser",{1:["edge", "Brawler", "at least", 0]}, "A real heavy hitter. Does d8 instead of d6 damage on unarmed rolls", {1:["parry", "", "plus", 0]}),
                      ...
                      Edge.Edge("Improved Counterattack",{1:["level", "", "at least", 8], 2:["edge","Counterattack","equal",0]}, "Trying to attack but failing to kill this character could be a deadly mistake. No penalty on counterattack", {1:["parry", "", "plus", 0]}),
                      ...
                      Edge.Edge("Improved Dodge",{1:["level", "", "at least", 8],2:["edge","Dodge","equal",0]}, "Bullets are my friends. I've studied them; learned their ways. (-2 to being hit with ranged attacks", {1:["parry", "", "plus", 0]}),
                      ...
                      Edge.Edge("Improved Extraction",{1:["edge", "Extraction", "at least", 0]}, "When the going gets tough, you've already left. Same a 'Extraction', but on a raise, ignore all free attacks.", {1:["parry", "", "plus", 0]}),
                      ...
                      Edge.Edge("Fervor",{1:["level", "", "at least", 8], 2:["attr", "spirit","at least",3], 3:["edge","command", "equal", 0]}, "Troops under this character's command gain +1 to all melee damage", {1:["parry", "", "plus", 0]}),
                      ...
                      Edge.Edge("Improved First Strike",{1:["level", "", "at least", 12],2:["edge","First Strike","equal",0]}, "Do not engage! This character can attack any foe who moves adjacent for free", {1:["parry", "", "plus", 0]}),
                      ...
                      Edge.Edge("Improved Frenzy",{1:["level", "", "at least", 8], 2:["edge","Frenzy","equal",0]}, "This character gains an additional fighting attack without penalty", {1:["parry", "", "plus", 0]}),
                      ...
                      Edge.Edge("Hold the Line!",{1:["level", "", "at least", 4], 2:["attr","smarts","at least", 3], 3:["edge","Command", "at least", 0]}, "They Shall not pass! Troops under this character's command gain +1 Toughness", {1:["parry", "", "plus", 0]}),
                      ...
                      Edge.Edge("Inspire",{1:["level", "", "at least", 4], 2:["edge", "Command","equal",0]}, "'Natural Leader' is an understatement. Troops love this character. Troops gain +1 to Spirit rolls", {1:["parry", "", "plus", 0]}),
                      ...
                      Edge.Edge("Leader of Men",{1:["level", "", "at least", 8], 2:["edge", "Command","equal", 0]}, "I don't know if you've heard, but this character is a natural leader. Subordinates gain a d10 wild die", {1:["parry", "", "plus", 0]}),
                      ...
                      Edge.Edge("Improved Level Headed",{1:["level", "", "at least", 4], 2:["edge", "Level Headed", "equal", 0]}, "In combat, this character draws three cards, and acts on the best of these", {1:["parry", "", "plus", 0]}),
                      ...
                      Edge.Edge("Very Lucky",{1:["edge", "Lucky", "at least", 0]}, "This character has two additional bennies per session", {1:["parry", "", "plus", 0]}),
                      ...
                      Edge.Edge("Improved Martial Artist",{1:["level", "", "at least", 8],2:["edge","Martial Artist","equal",0],3:["skill", "fighting", "at least", 4]}, "This character is a regular Danny Rand. +d6 to unarmed damage rolls, instead of d4", {1:["parry", "", "plus", 0]}),
                      Edge.Edge("Martial Arts Master",{1:["level", "", "at least", 16], 2:["edge","Improved Martial Artist", "equal", 0], 3:["skill", "fighting", "at least", 5]}, "The Fu Manchu of his people, this character gains +2 to unarmed damage rolls. This edge may be taken up to 5 times.", {1:["parry", "", "plus", 0]}),
                      ...
                      Edge.Edge("Natural Leader",{1:["attr", "spirit", "at least", 3], 2:["edge","Command","equal", 0]}, "By the very definition of the phrase, this character is a natural leader.",{1:["parry", "", "plus", 0]}),
                      ...
                      Edge.Edge("Scavenger",{1:["edge", "Luck", "at least", 0]}, "A lifetime of dumpster-diving has prepared this character for just such a moment. This character finds an essential piece of equipment once per session", {1:["parry", "", "plus", 0]}),
                      ...
                      Edge.Edge("Improved Sweep",{1:["edge", "Sweep", "at least", 0]}, "You really should shoot this guy. No penalty when attacking all adjacent foes.", {1:["parry", "", "plus", 0]}),
                      ...
                      Edge.Edge("Improved Tough as Nails",{1:["edge", "Tough as Nails", "at least", 0]}, "This edge is misleading. This character isn't really all that tough, at least not compared to this character.", {1:["toughness", "", "plus", 1]}),
                      ...
                      Edge.Edge("Improved Weapon Master",{1:["edge", "Weapon Master", "at least", 0]}, "If you've a weapon, this character has mastered it.", {1:["parry", "", "plus", 1]}),
